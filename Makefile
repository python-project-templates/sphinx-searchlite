...
lint-py:  ## lint python with ruff
	python -m ruff check sphinx_searchlite
	python -m ruff format --check sphinx_searchlite
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix sphinx_searchlite
	python -m ruff format sphinx_searchlite
...
test:  ## run python tests
	python -m pytest -v sphinx_searchlite/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v sphinx_searchlite/tests --cov=sphinx_searchlite --cov-report term-missing --cov-report xml
